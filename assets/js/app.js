...
let big_btn = document.querySelector(".w_h_77-34");
let small_btn = document.querySelector(".w_h_27-27");


big_btn.addEventListener("click", () => {
    small_btn.classList.toggle("right")
});

let boxes = document.querySelectorAll(".click-box");

boxes.forEach(box => {
    let check = box.querySelector(".check-img");
    let num = 1;

    box.addEventListener("click", () => {
        // check.innerHTML = `<svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M8.32164 16.2546C12.3755 16.2546 15.6618 12.9683 15.6618 8.91442C15.6618 4.86054 12.3755 1.57422 8.32164 1.57422C4.26776 1.57422 0.981445 4.86054 0.981445 8.91442C0.981445 12.9683 4.26776 16.2546 8.32164 16.2546Z" stroke="#979797" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            check.innerHTML = `<svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_34717_12754" x1="2.69189" y1="0.914062"
                                                x2="15.6291" y2="2.42084" gradientUnits="userSpaceOnUse">
